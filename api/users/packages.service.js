...
module.exports = {
  createPackage: (data, callBack) => {
    pool.query(
      `INSERT INTO practice_papers (typeofpaper, question, name, duration, noofsubjects, indiv_subs, indiv_mins, indiv_cutoff, papercutoff, status, date, prepared) values(?,?,?,?,?,?,?,?,?,?,?,?)`,
      [
        data.typeofpaper,
        data.maincategory,
        data.name,
